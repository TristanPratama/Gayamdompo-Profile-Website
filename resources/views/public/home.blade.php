...
@section('content')
    <div class="container p-3">
      <div class="row mb-3">
        ...
        <div class="col-lg-6">
          <p style="margin-bottom: 0; margin-top:1rem"><i class='bx bxl-whatsapp me-2'></i>Call Center : +62 895-3736-32000</p>
          <p style="margin-bottom: 0;"><i class='bx bxl-facebook-circle me-1'></i><i class='bx bxl-instagram-alt me-1'></i><i class='bx bxl-tiktok me-1'></i> : Kel.Gayamdompo</p>
